...
namespace NEsper.Catalyst.Configuration
{
    public class ConsumerElement : ConfigurationElement
    {
        ...
        {
            var factoryType = TypeHelper.ResolveType(Type);
            ...
            return (IEventConsumerFactory) Activator.CreateInstance(factoryType);
        }

        /// <summary>
        /// Creates a consumer from the provided information.
        /// </summary>
        /// <returns></returns>
        public IEventConsumer CreateConsumer()
        {
            var eventConsumerFactory = GetFactory();
            return eventConsumerFactory.CreateConsumer(ConsumerConfiguration);
        }
